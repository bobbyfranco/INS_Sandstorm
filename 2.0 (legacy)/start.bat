...
@echo off
color 0a
title Insurgency Sandstorm Advanced Server Launcher 2.0 Legacy ^| Main Menu
...
:GameSetup
title Insurgency Sandstorm Advanced Server Launcher 2.0 Legacy ^| Server Settings
set Label=GameSetup
echo.
...
:MOTD
title Insurgency Sandstorm Advanced Server Launcher 2.0 Legacy ^| Create MOTD
set MD=1
echo.
...
:Admins
title Insurgency Sandstorm Advanced Server Launcher 2.0 Legacy ^| Assign Admins
echo.
